...
with open('./images_captions_all.csv') as f:
...
checkpoint_path = "./saved-model_all/cp.ckpt"
...
def create_new_caption(path_to_img):
    pred_caption = generate_caption(path_to_img, loaded_model)
    return pred_caption
